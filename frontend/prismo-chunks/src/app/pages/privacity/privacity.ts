  ...
  template: `
    ...
    <div class="arcade-viewport">
      <div class="crt-screen success-theme">
        ...
        <div class="screen-header">PRIVACY_LOG</div>
        
        <div class="screen-body code-scroll">
          <h1>PRIVACIDADE</h1>
          <p>> CHAVES DIFFIE-HELLMAN GERADAS A CADA HANDSHAKE EFEMERO.</p>
          <p>> PERMISSOES ARMAZENADAS EM RUNTIME PROTEGIDO.</p>
          <p>> ISOLAMENTO DE SESSAO ATIVO EM NIVEES DE SEGURANCA RWU.</p>
        </div>
