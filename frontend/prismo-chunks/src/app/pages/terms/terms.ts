  ...
  template: `
    ...
    <div class="arcade-viewport">
      <div class="crt-screen info-theme">
        ...
        <div class="screen-header">TERMS_SYS</div>
        
        <div class="screen-body code-scroll">
          <h1>TERMOS DE USO</h1>
          <p>> OPERACAO BASEADA EM ASSINATURAS REIDRATAVEIS DA SESSAO.</p>
          <p>> VIOLACAO DE PERMISSOES EM MEMORIA BLOQUEIA O RETORNO.</p>
          <p>> ESTEIRAS VERIFICAM ACESSO DINAMICAMENTE A CADA NAVEGACAO.</p>
        </div>
